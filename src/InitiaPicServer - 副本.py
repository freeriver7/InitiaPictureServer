            ...
            for dir in listDir:
                ...
                if len(listType) >= 2:
                    ...
                    if int(listType[1]) == 102:
                        if listType[0] in g_dictScoutDirLwfd:
                            g_dictScoutDirLwfd[listType[0]].append(listType[2])
                        else:
                            g_dictScoutDirLwfd[listType[0]] = []
                            g_dictScoutDirLwfd[listType[0]].append(listType[2])
...
#    if winproc.IsProcStarted("ExecUtil.exe") == True:
    ...
    for key in g_listZhidaoChanpin:
        listFormat = g_dictScoutDirLwfd[os.path.dirname(key)]
